...
var airRoutes = L.geoJson(null, {
  style: function (feature) {
    if (feature.properties.consSalesId === "BRRO") {
      return {
        color: "#005432",
        weight: 3,
        opacity: 1
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
		var content = "<table class='table table-striped table-bordered table-condensed'>" + 
      		...
      		"<tr><th>Book Number</th><td>" + feature.properties.book_num + "</td></tr>" + 
      		"<tr><th>Billing Customer Number</th><td>" + feature.properties.BillingCustNum + "</td></tr>" + 
      		"<tr><th>Bills To Sales ID</th><td>" + feature.properties.billtoSalesId + "</td></tr>" +
      		"<tr><th>Logbook Key</th><td>" + feature.properties.logbook_key + "</td></tr>" +
            "<tr><th>Consignee Sales Id</th><td>" + feature.properties.consSalesId + "</td></tr>" +
    ...
    layer.on({
      ...
      mouseout: function (e) {
        airRoutes.resetStyle(e.target);
      }
    });
  }
});

$.getJSON("data/vcgAirRoutes.json", function (data) {
  airRoutes.addData(data);
});
